...
# हेडर का डायनामिक कलर मोमेंटम तय करना
if selected_asset == "NIFTY 50":
...
# ==============================================================================
# 4. मुख्य 5-कॉलम मास्टर ऑप्शन चेन टेबल ग्रिड (OI Details vs VOLUME Details)
# ==============================================================================
...
<table class="master-table-v3">
    <tr style="background-color: #1f242d;">
        <th style="width: 20%;">CE Phase<br>(With Score)</th>
        <th style="width: 22%;">OI Details<br>VOL / OI PCR<br>Chg OI VOL / CH PCR</th>
        <th style="width: 16%;">ST/Strike<br>(PCR / VolPCR)</th>
        <th style="width: 22%;">VOLUME Details<br>VOLUME / VOL Strength<br>Chg VOLUME / Chg VOL Strength</th>
        <th style="width: 20%;">PE Phase<br>(With Score)</th>
    </tr>
"""
...
for i in range(-5, 6):
    ...
    if i == 0:
        ...
        ce_phase = "<span class='txt-green'>Long Build-up (86+)</span><br><span class='txt-yellow'>🟡</span><br>11:30 AM | 20m"
        pe_phase = "<span class='txt-blue'>Short Covering (84+)</span><br><span class='txt-yellow'>🟡</span><br>09:45 AM | 65m"
        ...
        ce_phase = "<span class='txt-blue'>Short Covering (90+)</span><br><span class='txt-yellow'>🟡</span><br>10:15 AM | 45m"
        pe_phase = "<span class='txt-red'>Short Buildup (83+)</span><br>01:10 PM | 15m"
        ...
        ce_phase = "<span class='txt-blue'>Short Covering (85+)</span><br>10:15 AM | 45m"
        pe_phase = "<span class='txt-green'>Heavy Put Writing (79+)</span><br>01:10 PM | 15m"
...
# Final Alert Reasoning संदेश का मंदी/तेजी के हिसाब से 100% सटीक प्रदर्शन
if not is_market_green:
...
# स्विंग हाई/लो और पिछले दिन के OHLC आधारित लाइव प्राइस एक्शन फ़िल्टर का गणितीय मॉडल
