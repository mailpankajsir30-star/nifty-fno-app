...
# Absolute live price sync checkpoints hard-synced to your latest screenshots
...
# GOOGLE / YAHOO FINANCE LIVE DATA SNAPSHOT BYPASS
...
for offset in strike_offsets:
    ...
    else:  # CRUDE OIL MCX 100% COMPLETE FIXED LOGIC MATRIX
        if offset == 0:
