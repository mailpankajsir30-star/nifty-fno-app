...
# DYNAMIC MARKET TIME CHECK LOCK (SHAM 3:30 KE BAAD SIMULATION SHUTDOWN)
...
# ASSET SPECIFIC REAL BASE LOCKS
if selected_asset == "CRUDE OIL":
    ...
    # Commodity Sessions till 11:30 PM
...
# 🛡️ THE GUARANTEE: ENGINE STOPS OSCILLATING IF ASSET MARKET IS CLOSED
if is_asset_live and has_dhan_api and dhan_token != "eyJ0eX...token_code_yahan":
    ...
    # COMPLETELY FREEZE TO RELEVANT STOCK/COMMODITY WATCHLIST NUMBER
    live_spot_price = base_price_val
...
<div style="background-color: #161b22; padding: 12px; border-radius: 6px; border: 1px solid #3498db; font-size: 12px; line-height: 1.6;">
    ...
    • <b>💎 High Liquidity Zone Point:</b> Strike <b>{mock_liq_point}</b> (Order Matching Block - Operators Trapping Core)<br>
