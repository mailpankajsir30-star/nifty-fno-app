...
# पूरे पेज को वाइड लेआउट पर सेट किया गया है ताकि आईपैड और कंप्यूटर का पूरा स्पेस मिले
st.set_page_config(layout="wide", page_title="Universal Indian Derivatives Quant Matrix")
...
st.markdown("""
    ...
    .section-divider { background-color: #1e293b !important; color: #ffff00 !important; font-weight: bold !important; font-size: 11px !important; text-align: center !important; padding: 8px !important; }
...
if "BANK" in selected_asset:
    ...
    news_msg = "🔥 ग्रीड अलर्ट (HIGH GREED): FIIs द्वारा收藏 कैश मार्केट में लगातार ब्लॉक डील्स चालू हैं। हर डिप पर आक्रामक कॉल बाइंग हो रही है।"
...
html += '<tr class="blink-active"><td colspan="5" class="alert-line" style="color:#ffff00 !important; font-weight:bold;">🚀 QUANTUM FUSION METRICS ALERT: 🟢 TAKE CALL BUY ACTIVE (🎯 Confidence: 94%)<br><span style="color:#9ca3af; font-weight:normal; font-size:10px;">• रीज़न: Institutional Net Delta Imbalance > 3.8X पार है, ' + selected_asset + ' के OTM स्तर पर Vanna Squeeze एक्टिव है।<br>• होल्ड नियम: जब तक डेल्टा बायर के पक्ष में है बने रहें, स्विंग लो break होते ही एग्जिट करें।</span></td></tr>'
html += '<tr><td colspan="5" class="alert-line" style="color:#ff4d4d; background-color:#1a0505;">🛑 <b>LIVE AI STATUS: STRICTLY NO TRADE !!!</b><br>• रीज़न: ' + selected_asset + ' सपोर्ट पर भारी PE OI होने पर भी OI Trap Detector सक्रिय है। Delta Deceleration और Chg VOL Shock ऑन है। सेलर्स हेजिंग मैनिपुलेशन करके बायर्स को बुरी तरह फंसा रहे हैं।</td></tr>'
html += '<tr><td colspan="5" class="alert-line" style="color:#ffaa00; background-color:#121003;">⚠️ <b>REVERSAL SATARK ZONE & OHLC LEVELS:</b><br>• 🎯 Pull-Back: Active @ ' + pbl + ' - ' + pbh + ' | • 🛑 Pull-Down: Active @ ' + pdl + ' - ' + pdh + '<br>• 🏹 SWING LIQUIDITY TRAP: Swing High Sweep Rejection @ ' + pdl + ' (फेक ब्रेकआउट ज़ोन)<br>• 📌 MARKET STATUS: भाव अभी PDC के ऊपर सेंटर पर ट्रेड कर रहा है। जब तक ' + low_limit + ' का स्विंग लो सुरक्षित है, तब तक बायर्स हावी रहेंगे।</td></tr>'
