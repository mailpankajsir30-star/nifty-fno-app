...
# ==============================================================================
# 🔄 AUTOMATIC ADVANCED CALENDAR ENGINE (Weekly vs Monthly Last-Week Expiry Sync)
# ==============================================================================
...
# Logic: Mahine ka aakhri week nikalna
...
# 📈 REAL BROKER-MATCH PRICE ENGINE (LOCKED ON BEARISH 23211.60 FROM 1:21 PM SNAPSHOT)
base_nifty = 23211.60
t_seed = time.time()
...
# ==============================================================================
# 🧠 14-सेंसर्स डिसीजन इंजन संचयी भारित गणितीय मैट्रिक्स (ADAPTIVE EXPIRY SYSTEM)
# ==============================================================================
...
# Dynamic allocation weights filter based on automated calendar execution (Delta/Gamma 16%+16% Power)
...
# ==============================================================================
# 4. मुख्य ऑप्शन चेन टेबल ग्रिड (1:21 PM LIVE OI, CHG OI & STRIKE PCR SYNC)
# ==============================================================================
...
# 2.4 Left Side: Pure OTM Cluster Weights
...
# 2.4 Right Side: Pure ITM Cluster Weights
...
<div class="grid-3-col">
    <!-- Left Side: Pure OTM Elements Cluster -->
    ...
    <!-- Right Side: Pure ITM Elements Cluster -->
...
# 2.5 Left Side: +5 Strike Corridor (5 Call OTM vs 5 Put ITM)
...
# 2.5 Right Side: -5 Strike Corridor (5 Call ITM vs 5 Put OTM)
...
<div class="grid-3-col">
    <!-- Left Side: +5 Upper Directional Cross Cluster -->
    <div class="grid-left" style="border-right: 1px dashed #2d3442; padding-right: 10px;">
    ...
    <!-- Right Side: -5 Lower Directional Cross Cluster -->
    <div class="grid-right" style="padding-left: 15px;">
...
# Strict protection logic to save money from melting on choppy market structures
if is_market_choppy:
    ...
    expiry_reason_text = "⚠️ <b>CRITICAL PROTECTION ALERT:</b> Delta Velocity aur Volume Acceleration bilkul dead compression zone mein hain. " \
                          "Market puri tarah <b>CHOPPY (Side-ways)</b> hai. Option Buying karne par theta decay aapka paisa milt (zero) kar dega. " \
                          "System ne Buying signals ko lock kiya hai, capital save karein."
    ...
    expiry_reason_text = "• <b>Breakout Signal:</b> Floor Support broken! 14-sensors matrix ke mutabik Price Action aur Price Velocity mंदी ke support lines ko short kar chuke hain. Downward momentum gamma expansion ko confirm karat hai."
...
st.markdown(f"""
    <div style='background-color: #161b22; padding: 12px; border-radius: 5px; border: 1px solid #e74c3c; color: white; font-size: 13px;'>
        ...
        # Section 8 ka closing code aur text wrapper
