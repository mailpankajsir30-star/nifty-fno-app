...
# मोबाइल स्क्रीन पर ITM लाइन को कटने से रोकने और डेटा को ऊपर-नीचे टाइट लॉक रखने का CSS
st.markdown("""
    <style>
...
# 14-सेंसर डिसीजन इंजन का एकीकृत सटीक 100% संतुलित प्रोबेबिलिटी गणित
if is_expiry_day:
...
# ==============================================================================
# 4. मुख्य 11-रो ऑप्शन चेन टेबल ग्रिड (PURE FLEX-BOX FOR MOBILE VERTICAL LOCK)
# ==============================================================================
st.markdown("### 🖥️ 1. मास्टर ऑप्शन चेन रडार व्यू")

# हेडर पट्टी का इन-लाइन अलाइनमेंट
st.markdown("""
...
for i in range(-5, 6):
    ...
    if i == 0:
        ...
        ce_phase = "<span class='txt-green'>Long Build-up<br>(86+)</span><br><span class='txt-yellow'>🟡</span><br>11:30 AM"
        pe_phase = "<span class='txt-blue'>Short Covering<br>(84+)</span><br><span class='txt-yellow'>🟡</span><br>09:45 AM"
        ...
        ce_phase = "<span class='txt-blue'>Short Covering<br>(90+)</span><br><span class='txt-yellow'>🟡</span><br>10:15 AM"
        pe_phase = "<span class='txt-red'>Short Buildup<br>(83+)</span><br>01:10 PM"
        ...
        ce_phase = "<span class='txt-blue'>Short Covering<br>(85+)</span><br>10:15 AM"
        pe_phase = "<span class='txt-green'>Heavy Put Writing<br>(79+)</span><br>01:10 PM"
    ...
    # फ्लेक्स कार्ड रेंडरिंग जो हॉरिजॉन्टल स्पेस को बांध कर रखेगा
    st.markdown(f"""
