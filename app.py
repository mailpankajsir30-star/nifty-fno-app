...
# ------------------------------------------------------------------------------
# ⏱️ इन-बिल्ट भारतीय मानक समय (IST) लाइव क्लॉक इंजन (NO PYTZ ERROR)
# ------------------------------------------------------------------------------
# सर्वर के यूटीसी टाइम में मैन्युअल +5 घंटे और 30 मिनट जोड़कर आईएसटी निकालना
...
# चेंज बटन या लाइव मार्केट फीड के लिए टॉगल (टेस्टिंग हेतु)
...
# ------------------------------------------------------------------------------
# 📊 14-सेंसर वेटेड डिसीजन इंजन का एकीकृत स्कोर वितरण (% DISTRIBUTION ENGINE)
# ------------------------------------------------------------------------------
if is_expiry_day:
...
# ==============================================================================
# 6. UNIFIED AI DECISION SCORES (14 सेंसर डिसीजन मैपिंग और दिशात्मक रंग)
# ==============================================================================
st.markdown("---")
st.markdown("### 🤖 3. UNIFIED AI DECISION SCORES (% DISTRIBUTION ENGINE)")

# आपके कड़े डिसीजन मैपिंग नियमों के आधार पर सटीक वर्गीकरण टेक्स्ट
...
# ==============================================================================
# 7. EXPIRY DAY SPECIAL AI CONFIDENCE ENGINE (IV & THETA SYNC)
# ==============================================================================
st.markdown("---")
st.markdown("### 🍏 4. EXPIRY DAY SPECIAL AI CONFIDENCE ENGINE (IV & THETA SYNC)")

is_market_open_now = False  # बाजार सत्र सप्ताहांत पर बंद रहता है
...
if is_actual_expiry_day:
    st.info("🔮 **EXPIRY MODEL STATUS: NET CONFIDENCE = 85% (GAMMA BLAST PROBABILITY HIGH 💣)**\n\n"
            ...
            "जो थीटा मोमेंटम वेलोसिटी को पूरी तरह ओवरपॉवर कर रहा है। बड़ा जैकपॉट गामा कामना ब्लास्ट पूरी तरह पुष्ट है।")
else:
    st.markdown("""
...
# ==============================================================================
# 🆕 8. बॉटम लाइन्स सिंक एवं तार्किक रीज़निंग इंजन (BOTTOM LINES SYNC WITH REASONS)
# ==============================================================================
st.markdown("---")
st.markdown("### 🏛️ 5. BIG PLAYERS PANIC, SAFE ZONE & ULTIMATE QUANT ALERTS")

# 1. SYSTEM STATUS (14 सेंसर्स डेटा स्ट्रीम API गवाही)
st.success("🔮 SYSTEM STATUS: UNIFIED MODEL RUNNING OPERATIONAL (FVS = 100)")

# 2. QUANTUM FUSION METRICS ALERT (तार्किक कारणों के साथ स्पष्ट इंडिकेशन सिंक)
if is_market_green:
    ...
    st.markdown(f"""
        <div style='background-color: #161b22; padding: 12px; border-radius: 5px; border: 1px solid #2ecc71; color: white; font-size: 13px;'>
            <span class='txt-green' style='font-size: 15px;'>🟢 QUANTUM FUSION METRICS ALERT: TAKE CALL BUY ACTIVE (🎯 Confidence: {call_score}%)</span><br>
            <span style='color: #a3b8cc;'><b>Logical Reason:</b> {alert_reason_str}</span>
        </div>
    """, unsafe_allow_html=True)
else:
    ...
    st.markdown(f"""
        <div style='background-color: #161b22; padding: 12px; border-radius: 5px; border: 1px solid #e74c3c; color: white; font-size: 13px;'>
            <span class='txt-red' style='font-size: 15px;'>🔴 QUANTUM FUSION METRICS ALERT: TAKE PUT BUY ACTIVE (🎯 Confidence: {put_score}%)</span><br>
            <span style='color: #a3b8cc;'><b>Logical Reason:</b> {alert_reason_str}</span>
        </div>
    """, unsafe_allow_html=True)

# ==============================================================================
# 9. ADVANCED REVERSAL SATARK ZONE & OHLC LEVELS (पिछली 50 कैंडल्स स्विंग + PD OHLC)
# ==============================================================================
st.write("")
