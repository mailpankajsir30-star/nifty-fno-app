...
# सीएसएस: कड़े 5-कॉलम मोबाइल लेआउट और केवल सक्रिय बिंदी की ब्लिंकिंग को लॉक करने के लिए
st.markdown("""
    <style>
...
# --- बैंक निफ्टी और सेंसेक्स का सटीक वास्तविक भाव (74243 फिक्स) और ITM/OTM इंजन ---
...
else:  # SENSEX (74243 पर बंद भाव के अनुसार सटीक एटीएम 74200 फिक्स)
