...
# सीएसएस: नंबरों को बिना किसी HTML एरर के कड़े तरीके से ऊपर-नीचे 3 लाइनों में लॉक करने के लिए
st.markdown("""
    <style>
...
st.write("📲 5-कॉलम मोबाइल फ़िट | कंबाइंड डेटा + पीसीआर और चेंज ऑफ पीसीआर सिंक")
...
def get_broker_ui_data():
    ...
    for s in strikes:
        ...
        # आपकी सटीक डिमांड: OI, Volume, और दोनों PCR (PCR + Chg PCR) को एक ही बॉक्स में ऊपर-नीचे सिंक किया
        rows.append({
            "CE Phase": ce_phase,
...
# 2. AI डिसीजन बॉक्स
st.subheader("🧠 AI इंस्टीट्यूशनल डिसीजन और एक्शन推 प्लान")
