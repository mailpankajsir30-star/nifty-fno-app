...
for idx, s in enumerate(strikes):
    ...
    # 🕵️ टाइम-स्टैम्प और अनवाइंडिंग ट्रैकर लॉजिक (कब से कितने मिनट से फेज शुरू हुआ)
...
# --- 🧠 🛠️ ऑल-इन-वन वेटेड AI डिसीजन स्कोर कैलकुलेटर Engine ---
...
# 🏛️ नया जोड़ा गया वेटेड % AI डिसीजन मैट्रिक्स पैनल (Width Compressed Layout)
...
# 🏛️ एक्सपायरी डे स्पेशल AI कॉन्फिडेंस पैनल
