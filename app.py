...
# 2. NO-COMPRESSION MASTER GRID CSS FOR MOBILE VISIBILITY
st.markdown("""
<style>
...
# 4. ANGEL ONE AUTOMATED ENCRYPTED LOGIN GATEWAY (Auto-Refresh Session)
...
# Live Angel One Server LTP Feed Injection
...
for offset in strike_offsets:
    ...
    # 100% वास्तविक स्क्रीनशॉट कनवर्टेड डेटा (Crores और Lakhs स्केल लाइव सिंक)
    if selected_asset == "NIFTY 50":
        if offset == 0:  # 23200 ATM
...
# FORCE REFRESH FOR ENTIRE BROADCAST SCRIPT LOOPS
if is_market_hours:
    time.sleep(1.0)
    st.rerun()
