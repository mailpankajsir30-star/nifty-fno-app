...
# FIXED NATIVE DARK STYLE THEME OVERRIDE
st.markdown("""
<style>
...
# 📊 AUTOMATIC POST-MARKET STATIC LOCK SYSTEM ENGINE
...
# 📊 TRADINGVIEW LIVE ACCURATE WATCHLIST ALIGNMENT
...
<div style="background-color: #161b22; padding: 12px; border-radius: 6px; border: 1px solid #3498db; font-size: 12px; line-height: 1.6;">
    ...
    • <b>📊 Previous Day High (PDH) Corridor:</b> Strike <span class="txt-red"><b>{atm_strike_base + (3 * interval)}</b></span> Barrier Wall<br>
...
Data Matrix ke mutabik Explosive Gamma Breakout Seek generate ho raha hai. Range burst hote hi premium multiplication alert trigger hoga!""", unsafe_allow_html=True)if is_asset_live:time.sleep(1.0)st.rerun()
