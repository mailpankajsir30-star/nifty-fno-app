...
call_score, put_score, sideways_score, no_trade_score = 82.5, 3.5, 6.0, 8.0
# ==============================================================================
...
st.markdown(f"""
    <div style='background-color: #161b22; padding: 12px; border-radius: 5px; border: 1px solid #2ecc71; color: white; font-size: 13px;'>
        ...
        • Call Seller Panic Zone: <b>Above {atm_strike_base + 100}</b>. यहाँ Massive Gamma Blast सक्रिय होगा।<br>
        • Put Seller Panic Zone: <b>Below {atm_strike_base - 100}</b>.<br><br>
        <b>🛡️ INSTITUTIONAL SAFE ZONE (Corridor):</b><br>
        • <b>{atm_strike_base - 100} — {atm_strike_base + 100}</b> के दायरे में बाजार पूरी तरह सुरक्षित हेज्ड रहेगा।
    </div>
""", unsafe_allow_html=True)
...
with col_rev1:
    ...
    <div style='background-color: #1b2a22; padding: 12px; border-radius: 5px; border: 1px solid #2ecc71;'>
        ...
        <span style='font-size: 20px; font-weight: bold; color: white;'>{atm_strike_base - 150} — {atm_strike_base - 100}</span>
    </div>
    """, unsafe_allow_html=True)
...
with col_rev2:
    ...
    <div style='background-color: #2c1a1d; padding: 12px; border-radius: 5px; border: 1px solid #e74c3c;'>
        ...
        <span style='font-size: 20px; font-weight: bold; color: white;'>{atm_strike_base + 100} — {atm_strike_base + 150}</span>
    </div>
    """, unsafe_allow_html=True)
